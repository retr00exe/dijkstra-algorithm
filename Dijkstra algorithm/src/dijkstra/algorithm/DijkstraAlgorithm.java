...
public class DijkstraAlgorithm extends JFrame {
...
// ***** lists *****
 ...
 // ***** buttons *****
 JRadioButton rbtnAddVertex =new JRadioButton("Tambah Vertex");
 JRadioButton rbtnAddEdge=new JRadioButton("Hubungkan Vertex");
 JRadioButton rbtnMoveVertex =new JRadioButton("Pindah Vertex");
 JRadioButton rbtnShortestPath=new JRadioButton("Hitung Shortest Path");
 JButton btnaddAllEdge=new JButton("Hubungkan Semua Vertex");
 ...
 public void setButtons() {
	 ...
	 rbtnMoveVertex.addActionListener(new ActionListener() {
		@Override
		public void actionPerformed(ActionEvent e) {
			setLabel(Color.RED,"Pilih vertex.");
	 ...
	 rbtnAddVertex.addActionListener(new ActionListener() {
		 @Override	
		 public void actionPerformed(ActionEvent e) {
			setLabel(Color.RED,"Klik di dalam box putih untuk menambahkan vertex.");
			panel.removeMouseListener(cl2);
